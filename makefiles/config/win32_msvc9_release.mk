...
# potentially should be x86/Release but if we have VC9 and VC10 on the same
...
I_LFLAGS = /incremental:no /nodefaultlib /fixed:no $(G_OPTIMIZE_LFLAGS) $(U_WIN32_RELEASE_LFLAGS)
