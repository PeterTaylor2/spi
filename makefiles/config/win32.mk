...
G_PYTHON_LIBS=$(U_SPI_HOME)/python/x86/lib/python$(G_PY_VERSION)$(G_DEBUG_EXT).lib
...
ifdef G_WIN32_NO_UUID
G_NO_UUID=$(G_WIN32_NO_UUID)
else
G_NO_UUID=0
endif
