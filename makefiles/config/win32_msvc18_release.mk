...
# using the VC18 compiler

G_ABI=Release-x86-vc18
G_BUILD_DIR=win32/msvc18_release

ifeq ($(G_WIN32_COMPILER),msvc18)
G_ABI=Release-x86
endif

include $(U_MAKEFILES)/config/win32_msvc18.mk
...
G_WIN32_MSVC_OPTIMIZE?=-O2
I_DEFINES = -D_CRT_SECURE_NO_WARNINGS $(U_DEFINES) $(U_WIN32_RELEASE_CFLAGS)
I_CFLAGS = -c -MD -W3 -Gy -nologo $(G_WIN32_MSVC_OPTIMIZE) $(I_DEFINES)
...
G_CFLAGS = $(I_CFLAGS) /arch:SSE2 $(U_WIN32_CFLAGS)
G_CPPFLAGS = $(I_CFLAGS) -EHsc /arch:SSE2 $(U_WIN32_CPPFLAGS)

endif

G_MSBUILD_PROPERTIES=/p:Configuration=Release /p:Platform=x86
