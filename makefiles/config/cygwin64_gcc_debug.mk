...
G_ABI=Debug-cygwin64
G_BUILD_DIR=cygwin64/gcc_debug
G_DEBUG=_d
...
I_CFLAGS = -pthread -m64 -Wall -Werror -Wno-unused-value -Wno-deprecated -Wno-unused-variable -Wno-unused-but-set-variable -Wno-write-strings -Wno-sequence-point -ggdb3 -c -fPIC -pipe $(I_DEFINES)
