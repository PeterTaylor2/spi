...
I_WINDOWS_KITS_BIN=$(G_WIN32_PROGRAM_FILES)/Windows Kits/10/bin/$(G_VS18_KITS_VERSION)/x86
G_WINDOWS_REDIST_DLLS_HOME=$(I_WIN32_PROGRAM_FILES_DOS)\Windows Kits\10\Redist\$(G_VS18_KITS_VERSION)\ucrt\DLLS\x86

I_VS18_PATH:=$(I_VS18_HOME)/VC/Tools/MSVC/$(G_VS18_TOOLS_VERSION)/bin/Hostx86/x86:$(I_VS18_HOME)/Common7/IDE:$(I_WINDOWS_KITS_BIN):$(I_VS18_HOME)/MSBuild/Current/Bin
...
LIB:=$(I_VS18_HOME_DOS)\VC\Tools\MSVC\$(G_VS18_TOOLS_VERSION)\lib\x86;$(I_WINDOWS_KITS_BASE_LIB)\ucrt\x86;$(I_WINDOWS_KITS_BASE_LIB)\um\x86;$(I_WINDOWS_KITS)\NETFXSDK\$(G_VS18_NETFXSDK_VERSION)\Lib\um\x86
