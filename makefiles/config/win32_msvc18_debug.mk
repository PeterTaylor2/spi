...
G_ABI=Debug-x86-vc18
G_BUILD_DIR=win32/msvc18_debug
...
G_CFLAGS = $(I_CFLAGS) -Zi $(U_WIN32_CFLAGS)
G_CPPFLAGS = $(I_CFLAGS) -Zi -EHsc $(U_WIN32_CPPFLAGS)

endif

G_MSBUILD_PROPERTIES=/p:Configuration=Debug /p:Platform=x86
