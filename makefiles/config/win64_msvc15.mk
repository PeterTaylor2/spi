...
G_WINDOWS_REDIST_DLLS_HOME=$(I_WIN32_PROGRAM_FILES_DOS)\Windows Kits\10\Redist\$(G_VS15_KITS_VERSION)\ucrt\DLLS\x64

I_VC15_PATH:=$(I_VS15_HOME)/VC/Tools/MSVC/$(G_VS15_TOOLS_VERSION)/bin/Hostx86/x64:$(I_VS15_HOME)/Common7/IDE:$(I_WINDOWS_KITS_BIN):$(I_VS15_HOME)/MSBuild/15.0/Bin/amd64
