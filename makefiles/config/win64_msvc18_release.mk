...
G_ABI=Release-x64-vc18
G_BUILD_DIR=win64/msvc18_release

ifeq ($(G_WIN32_COMPILER),msvc18)
G_ABI=Release
endif

include $(U_MAKEFILES)/config/win64_msvc18.mk
...
G_CFLAGS = $(I_CFLAGS) $(U_WIN64_CFLAGS)
G_CPPFLAGS = $(I_CFLAGS) -EHsc $(U_WIN64_CPPFLAGS)

endif

G_MSBUILD_PROPERTIES=/p:Configuration=Release /p:Platform=x64
