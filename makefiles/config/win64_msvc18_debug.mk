...
G_ABI=Debug-x64-vc18
G_BUILD_DIR=win64/msvc18_debug
...
G_CFLAGS = $(I_CFLAGS) -Zi $(U_WIN64_CFLAGS)
G_CPPFLAGS = $(I_CFLAGS) -Zi -EHsc $(U_WIN64_CPPFLAGS)

endif

G_MSBUILD_PROPERTIES=/p:Configuration=Debug /p:Platform=x64
