...
v18.vcxproj:
	$(G_PYTHON) $(U_SPI_HOME)/makefiles/python/makeVcproj18Config.py --vcTarget=v18.vcxproj $(U_VCXPROJ_OPTIONS) -b $(U_MAKEFILES)/cygwin32/bin $(U_VCPROJ).v18.vcxproj $(U_VCPROJ) . $(U_SERVICE).svo
