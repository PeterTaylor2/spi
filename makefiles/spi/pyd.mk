...
v15.vcxproj::
	@$(I_VCPROJ15_CMD) -j1 -t "install INSTALL_FROM_VS=1" -b $(U_MAKEFILES)/cygwin32/bin $(U_VCPROJ)-install.v15.vcxproj $(U_VCPROJ)-install . .

v16.vcxproj::
	@$(I_VCPROJ16_CMD) -j1 -t "install INSTALL_FROM_VS=1" -b $(U_MAKEFILES)/cygwin32/bin $(U_VCPROJ)-install.v16.vcxproj $(U_VCPROJ)-install . .

v17.vcxproj::
	@$(I_VCPROJ17_CMD) -j1 -t "install INSTALL_FROM_VS=1" -b $(U_MAKEFILES)/cygwin32/bin $(U_VCPROJ)-install.v17.vcxproj $(U_VCPROJ)-install . .
...
I_INSTALL_FILES=\
$(G_DLL_PFX)$(SPI_DLL)$(G_INSTALL_DLL_EXT)\
$(G_DLL_PFX)$(SPI_UTIL_DLL)$(G_INSTALL_DLL_EXT)\
$(G_DLL_PFX)$(U_SERVICE_DLL)$(G_INSTALL_DLL_EXT)\
$(U_TARGET)$(G_INSTALL_PYD_EXT)\
$(G_DLL_PFX)$(SPI_DLL)-py$(G_PY_VERSION)$(G_INSTALL_DLL_EXT)\
$(notdir $(U_DLLS))
