...
###########################################################################
I_SPCS=$(wildcard $(U_SPI_HOME)/config/bin/$(G_ABI)/spcs$(G_EXE))
ifeq "$(I_SPCS)" ""
I_SPCS:=$(U_SPI_HOME)/config/bin-$(G_PLATFORM)/spcs$(G_EXE)
endif
...
$(I_CS_TARGET): $(I_CS_SOURCE) $(I_SPCS)
	@mkdir -p $(I_CS_SRC)
	$(I_SPCS) $(G_SPCS_OPTIONS) $(U_SPCS_OPTIONS) $(I_CS_SOURCE) $(I_CS_TARGET) $(I_CS_SRC) $(U_COMPANY_NAMESPACE) $(U_CS_DLL_NAME) "$(U_COMPANY_NAME)"
