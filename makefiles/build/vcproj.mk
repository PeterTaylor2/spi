...
v15.vcxproj:: 
	@$(I_VCPROJ15_CMD) $(I_INCLUDES) $(U_VCPROJ_OPTIONS) -b $(G_CYGWIN_BIN) $(I_VCPROJ).v15.vcxproj $(I_VCPROJ) $(U_SRC_DIR) $(U_INC_DIR)

v16.vcxproj:: 
	@$(I_VCPROJ16_CMD) $(I_INCLUDES) $(U_VCPROJ_OPTIONS) -b $(G_CYGWIN_BIN) $(I_VCPROJ).v16.vcxproj $(I_VCPROJ) $(U_SRC_DIR) $(U_INC_DIR)

v17.vcxproj:: 
	@$(I_VCPROJ17_CMD) $(I_INCLUDES) $(U_VCPROJ_OPTIONS) -b $(G_CYGWIN_BIN) $(I_VCPROJ).v17.vcxproj $(I_VCPROJ) $(U_SRC_DIR) $(U_INC_DIR)
