...
I_VCPROJ10_CMD=$(G_PYTHON) $(U_MAKEFILES)/python/makeVcproj10.py
I_VCPROJ14_CMD=$(G_PYTHON) $(U_MAKEFILES)/python/makeVcproj14.py
I_VCPROJ15_CMD=$(G_PYTHON) $(U_MAKEFILES)/python/makeVcproj15.py
...
v15.vcxproj:: 
	@$(I_VCPROJ15_CMD) $(I_INCLUDES) $(U_VCPROJ_OPTIONS) -b $(G_CYGWIN_BIN) $(I_VCPROJ).v15.vcxproj $(I_VCPROJ) $(U_SRC_DIR) $(U_INC_DIR) $(G_WIN32_COMPILER) $(G_WIN32_BITS)

v16.vcxproj:: 
	@$(I_VCPROJ16_CMD) $(I_INCLUDES) $(U_VCPROJ_OPTIONS) -b $(G_CYGWIN_BIN) $(I_VCPROJ).v16.vcxproj $(I_VCPROJ) $(U_SRC_DIR) $(U_INC_DIR) $(G_WIN32_COMPILER) $(G_WIN32_BITS)

v17.vcxproj:: 
	@$(I_VCPROJ17_CMD) $(I_INCLUDES) $(U_VCPROJ_OPTIONS) -b $(G_CYGWIN_BIN) $(I_VCPROJ).v17.vcxproj $(I_VCPROJ) $(U_SRC_DIR) $(U_INC_DIR) $(G_WIN32_COMPILER) $(G_WIN32_BITS)
