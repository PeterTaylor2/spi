...
v15.vcxproj:: 
	@$(I_VCPROJ15_CMD) $(I_INCLUDES) $(U_VCPROJ_OPTIONS) -b $(G_CYGWIN_BIN) --vcTarget=v15.vcxproj $(I_VCPROJ).v15.vcxproj $(I_VCPROJ) $(U_SRC_DIR) $(U_INC_DIR) $(G_WIN32_COMPILER) $(G_WIN32_BITS)
