...
// the version of DIA2Dump.cpp provided only works if you can register
// the DLL msdia140.dll using regsvr32 - but that needs admin rights
// this version of the code replaces DIA2Dump.cpp and admin rights
// are not needed
//
// it is hard to understand why Microsoft did not provide this version
// of the code instead
...
bool DumpAllGlobals(IDiaSymbol* pGlobal)
{
    IDiaEnumSymbols* pEnumSymbols;
    IDiaSymbol* pSymbol;
    enum SymTagEnum dwSymTags[] =
    { SymTagFunction, SymTagThunk, SymTagData };
    ULONG celt = 0;
