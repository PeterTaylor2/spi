...
#define NO_HEX_FP
/*
 This code is so ancient that it existed in a world of 16-bit and 32-bit
 we need to ensure that Long is precisely 32-bits.
 ULong is defined in terms of Long anyway so does not need to be re-defined
*/
#define Long int32_t
