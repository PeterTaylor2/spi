...
int cdecl Excel(int xlfn, LPXLOPER pxResult, int count, ...)
{
    ...
    xlret = Excel4v(xlfn,pxResult,count,(LPXLOPER *)(&count+1));
...
int cdecl Excel12f(int xlfn, LPXLOPER12 pxResult, int count, ...)
{
    ...
    xlret = Excel12v(xlfn,pxResult,count,(LPXLOPER12 *)(&count+1));
...
LPXLOPER TempStrConst(const char* lpstr)
{
    LPXLOPER lpx;
    LPSTR lps;
    int len;
...
LPXLOPER12 TempStr12(const XCHAR* lpstr)
{
    ...
    len = lstrlenW(lpstr);
    if (len > 255)
        len = 255; // it seems that we are still limited to the old length
...
{
    return TempActiveRef12(rw, rw, 0, 0x7FFFFFFF);
}
...
{
    return TempActiveRef12(0, 0x7FFFFFFF, col, col);
}
...
BOOL XLOper12ToXLOper(LPXLOPER12 pxloper12, LPXLOPER pxloper)
{
    ...
    case xltypeNum:
        ...
        break;
    case xltypeBool:
        pxloper->val.boolean = pxloper12->val.xbool;
        break;
    case xltypeErr:
    ...
    case xltypeStr:
        ...
        {
            ast = (char*)malloc((cach + 2) * sizeof(char));
            if (ast == NULL)
            {
                fRet = FALSE;
            }
    ...
    case xltypeMulti:
        ...
        else
        {
            ...
            {
                rgxloperConv = (LPXLOPER)malloc(cxloper12 * sizeof(XLOPER));
...
BOOL XLOperToXLOper12(LPXLOPER pxloper, LPXLOPER12 pxloper12)
{
    ...
    case xltypeNum:
        ...
        break;
    case xltypeBool:
        pxloper12->val.xbool = pxloper->val.boolean;
        break;
    case xltypeErr:
    ...
    case xltypeMulti:
        ...
        else
        {
            ...
            {
                rgxloper12Conv = (LPXLOPER12)malloc(cxloper * sizeof(XLOPER12));
