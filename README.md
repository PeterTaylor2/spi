...
Any code generated by the code generators is unlicensed - but you can apply your own license if you wish.
...
solution file. Most of the code over the years has been developed within Visual Studio - currently VS16 (2019)
and VS17 (2022) are fully supported.
...
We bundle header files and libraries for the following versions of Python for Windows: 27, 37 to 313.
We support both 32-bit and 64-bit versions of Python, but we have stopped bundling Python libraries for 32-bit
after version 310.
...
However for C# we are now requiring use of .NET version 8 or above - the visual studio project files are greatly
simplified, and we have support for nullable values and use of the 'using' keyword.
